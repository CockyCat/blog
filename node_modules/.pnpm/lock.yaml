...
packages:
  ...
  /hexo-util/2.6.1:
    resolution: {integrity: sha512-xj1jUrId2qTe8L/tRizWWRl+j7X1Zzh5rCVtffboOU0p/EfbPomxIxDvntTHT3fcqgvLHsncqJF9V5j7+buOqA==}
    engines: {node: '>=12.4.0'}
    dependencies:
      bluebird: 3.7.2
      camel-case: 4.1.2
  ...
  /micro-memoize/4.0.10:
    resolution: {integrity: sha512-rk0OlvEQkShjbr2EvGn1+GdCsgLDgABQyM9ZV6VoHNU7hiNM+eSOkjGWhiNabU/XWiEalWbjNQrNO+zcqd+pEA==}
    dev: false
  ...
  /warehouse/4.0.1:
    resolution: {integrity: sha512-rFJYdHlk2C+pKAoV4Nlptb+b7nmBN5QOg8VkQVNMbK7jf/lDctaUF9nNehZqVoarDWS74nMpTWVDhWecWwoqQw==}
    engines: {node: '>=10.13.0'}
    dependencies:
      bluebird: 3.7.2
      cuid: 2.1.8
